...
import {BehaviorSubject, EMPTY, map, Observable, shareReplay} from 'rxjs';
import {AddressAPIProperties, AddressAPIResult} from './ng-address-data-gouv';

@Injectable({
  providedIn: 'root'
})
export class Service {
  private _uri = 'https://api-adresse.data.gouv.fr';
